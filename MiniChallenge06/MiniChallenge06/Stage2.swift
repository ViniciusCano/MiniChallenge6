...
class Stage2: UIViewController, ARSCNViewDelegate {
    ...
    func addBuilding(touch: UITouch) {
        ...
        self.building.addFloor(floor: ColumnFloorNode(coordinates: [(0, 0), (0, 4), (19, 0), (19, 4), (10, 4), (10, 0)]))
        self.building.addFloor(floor: FloorNode(numberOfXBlocks: 20, numberOfZBlocks: 5))
        self.building.addFloor(floor: ColumnFloorNode(coordinates: [(0, 0), (0, 4), (19, 0), (19, 4), (10, 4), (10, 0)]))
        self.building.addFloor(floor: FloorNode(numberOfXBlocks: 20, numberOfZBlocks: 5))
        self.building.addFloor(floor: ColumnFloorNode(coordinates: [(0, 0), (0, 4), (19, 0), (19, 4), (10, 4), (10, 0)]))
        self.building.addFloor(floor: FloorNode(numberOfXBlocks: 20, numberOfZBlocks: 5))
