...
//                node.physicsBody?.contactTestBitMask = 1
                ...
                node.physicsBody = SCNPhysicsBody(type: .dynamic, shape: SCNPhysicsShape(geometry: block, options: nil))
...
//                node.physicsBody?.isAffectedByGravity = false
        ...
        planeNode.position = SCNVector3(
            ...
            CGFloat(self.boundingBox.min.y),
